...
- Source of truth: `docs/ai-context`, `docs/specs` and `AI_OPERATING_MODEL.md`.
- This skill operationalizes ownership and isolation rules already decided in the official specs.
- Do not use it to invent a new tenancy model or override product boundaries.
