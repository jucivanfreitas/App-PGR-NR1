...
- Review against `docs/ai-context`, `docs/specs` and `docs/ai-skills` first.
- Do not let review heuristics redefine architecture, auth, ownership or deploy policy.
- If guidance conflicts with the official docs, the docs win.
