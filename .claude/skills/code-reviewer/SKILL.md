...
- Use this skill to review diffs against the official contracts, not to introduce new architecture or policy.
- If the skill conflicts with the docs, the docs win.
